...
import { MapPin, Calendar, Users, Leaf, TrendingUp, DollarSign, Award, Droplet, Recycle, Sun, Heart, GraduationCap, FileText, Download } from 'lucide-react';
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => alert('Descargando Informe Ambiental... (En producción esto generaría un PDF)')}
                ...
                <button
                  onClick={() => alert('Descargando Informe Social... (En producción esto generaría un PDF)')}
                ...
                <button
                  onClick={() => alert('Descargando Informe Económico... (En producción esto generaría un PDF)')}
